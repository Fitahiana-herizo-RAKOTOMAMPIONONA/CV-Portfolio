...
export default function NavigationCard({ description, title, icon: Icon, image, href = "#", className = "" }) {
    return (
      <div className={`card-animate ${className}`}>
        <Link to={href} className="block group h-full">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-1 hover:scale-105 transition-all duration-300 h-full">
            ...
            <div className="relative bg-slate-900 rounded-3xl p-8 h-full flex flex-col">
              {/* Icon/Image */}
              <div className="mb-6 flex-shrink-0">
                {image ? (
                  <div className="w-20 h-20 relative mx-auto lg:mx-0">
                    <img
                      src={image}
                      alt={title}
                  ...
                  <div className="w-20 h-20 mx-auto lg:mx-0 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="flex-1 flex flex-col justify-between text-center lg:text-left">
                <div>
                  ...
                  <h3 className="text-xl lg:text-2xl font-bold text-white group-hover:text-blue-400 transition-colors duration-200 mb-2">
                    {title}
                  </h3>
                </div>
                
                <div className="flex items-center justify-center lg:justify-start gap-2 mt-4 text-slate-400 group-hover:text-blue-400 transition-colors duration-200">

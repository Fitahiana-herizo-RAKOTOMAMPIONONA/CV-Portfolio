...
const experience = [
    {
        ...
        description: `Au sein de 42, j'ai acquis une solide expérience en maîtrisant 
            ...
            et les spécificités de 42, ce qui a renforcé mes compétences en programmation.
            Ce parcours a été avant tout autodidacte, avec un apprentissage basé sur l'échange 
            peer-to-peer, me permettant de progresser de manière autonome tout en bénéficiant 
        ...
        description: `Au sein du projet "Chat Traductor", une application de messagerie 
            ...
            avec MySQL et Socket.io, que j'ai appris à utiliser pour gérer les 
            bases de données et les communications en temps réel. En travaillant 
            avec une équipe, j'ai renforcé mes compétences en collaboration et en 
            gestion de projet, tout en perfectionnant mes connaissances de Git 
            pour le versionnage et la gestion du code source.Cette expérience 
        ...
        description: `Dans le cadre de mon projet Histories, j'ai 
            ...
            pour le design, et Node.js avec MySQL pour la gestion du backend.
            Ce projet m'a permis de renforcer mes compétences en développement
            web dynamique et d'acquérir une expérienceprécieuse 

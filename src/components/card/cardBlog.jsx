...
export default function CardBlog(props) {
    ...
    const defaultImage = "https://via.placeholder.com/800x400/cccccc/000000?text=Login+Image";
    ...
    return (
        <div className="mt-8 mb-8 backgroundPers rounded-xl overflow-hidden group transform transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-xl">
            ...
            <div className="w-full h-72 relative">
                <img 
                    src={props.data.cover_image || defaultImage}  // Image par défaut si aucune image
                    alt="Cover"
                ...
                />
                {/* Gradient overlay for elegant effect */}
            ...
            <div className="px-6 py-6 space-y-4">
                ...
                <div className="text-2xl font-semibold text-gray-100">{props.data.title}</div>
